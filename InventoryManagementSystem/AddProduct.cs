...
namespace InventoryManagementSystem
{
    public partial class AddProduct : Form
    {
        ...
        {
            if (activeIndex != -1 && activeIndex < tempAssociatedParts.Count)
            {
        ...
        private void AddButton_Click(object sender, EventArgs e)
        {
            if (activePart != null)
            {
                if (!tempAssociatedParts.Contains(activePart))
                {
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            Product tempProduct = new Product(ManagementSystem.ProductID++, tempName, tempPrice, tempInventory, tempMin, tempMax, tempAssociatedParts);
            ManagementSystem.Inventory.addProduct(tempProduct);
